...
import io.github.cloudiator.deployment.lance.CreateLanceProcessStrategy;
...
public abstract class DockerComponentSupplier {
  ...
  private Map<Option, List<String>> createOptionMap(Map<String, String> envMap) {
    ...
    createOptionMap
        .put(Option.ADD_HOST, new ArrayList<>(Arrays.asList("host.cloudiator.com:$CLOUD_IP")));
