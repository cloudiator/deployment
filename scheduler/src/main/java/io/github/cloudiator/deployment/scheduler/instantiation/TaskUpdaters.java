...
public class TaskUpdaters implements TaskUpdater {

  private final Set<TaskUpdater> taskUpdaters;

  @Inject
  protected TaskUpdaters(Set<TaskUpdater> taskUpdater) {
    this.taskUpdaters = taskUpdater;
  }
